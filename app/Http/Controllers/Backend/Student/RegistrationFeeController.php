...
class RegistrationFeeController extends Controller
{
    ...
    public function getStudent(Request $request)
    {
        ...
        foreach($allStudent as $key=> $v){
            ...
            $html[$key]['tdsource'] .= '<a href="'.route("students.reg.fee.payslip").'?class_id='.$v->class_id. '&student_id='.$v->student_id.'" class="btn btn-sm btn-'.$color.'" title="Payslip" target="_blank">Fee Slip</a>';
            $html[$key]['tdsource'] .= '</td>';
    ...
    public function payslip(Request $request)
    {
        ...
        return view('backend.student.registration_fee.registration-fee-pdf',$allStudent);
