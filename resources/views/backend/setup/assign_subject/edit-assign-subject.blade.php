                            ...
                            <div class="delete_whole_extra_item_add" id="delete_whole_extra_item_add">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-2">
                                        ...
                                        <input type="text" name="full_mark[]" value="{{ $edit->full_mark }}" class="form-control" placeholder="Enter Full Mark" required>
                                        {{-- <font style="color: red">{{ ($errors->has('amount[]'))?($errors->first('amount[]')):'' }}</font> --}}
                                    </div>
                                    <div class="form-group col-md-2">
                                        <label>Pass Mark</label>
                                        <input type="text" name="pass_mark[]" value="{{ $edit->pass_mark }}" class="form-control" placeholder="Enter Pass Mark" required>
                                    </div>
                                    <div class="form-group col-md-2">
                                        <label>Subjective Mark</label>
                                        <input type="text" name="subjective_mark[]" value="{{ $edit->subjective_mark }}" class="form-control" placeholder="Enter Get Mark" required>
                                    </div>
