      ...
      <div class="row">
        ...
        <section class="col-md-12">
          ...
          <div class="card">
            ...
            <div class="card-body">
                <strong>Employee Name: </strong>{{ $details->name }}, <strong>ID No: </strong>{{ $details->id_no }}, <strong>Join Date: </strong>{{ date('d-m-Y',strtotime($details->join_date)) }}
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            @if ($key == "0")
                                <td class="text-center" colspan="5"><strong>Joining Salary: {{ $value->previous_salary }} TK</strong></td>
                            @else
                                <td>{{ $key+1 }}</td>
