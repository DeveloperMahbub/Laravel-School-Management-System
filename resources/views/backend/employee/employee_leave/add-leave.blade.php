                ...
                <form method="post" action="{{ (@$editData)? route('employees.leave.update',$editData->id) : route('employees.leave.store') }}" id="myForm" enctype="multipart/form-data">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control form-control-sm {{ @$editData->start_date?"":'singledatepicker' }}" name="start_date" value="{{ @$editData->start_date }}" autocomplete="off" value="{{ @$editData->start_date }}" placeholder="Start Date" required>
                            <font style="color: red">{{ ($errors->has('start_date'))?($errors->first('start_date')):'' }}</font>
                        </div>
                        <div class="form-group col-md-4">
                            <label>End Date<font style="color: red">*</font></label>
                            <input type="text" class="form-control form-control-sm {{ @$editData->end_date?"":'singledatepicker' }}" value="{{ @$editData->end_date }}" autocomplete="off" name="end_date" value="{{ @$editData->end_date }}" placeholder="End Date" required>
                        ...
                        <div class="form-group col-md-8">
                            ...
                            <input type="text" name="name" value="{{ @$editData->name }}" class="form-control form-control-sm" placeholder="Write Purpose" id="add_others" style="display: none;margin-top:5px;">
